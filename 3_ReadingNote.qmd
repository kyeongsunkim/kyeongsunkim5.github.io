...
## Shen-Haw Ju(2013) Determination of scoured bridge natural frequencies with soil-structure interaction
...
::: {.callout-note icon="false"}
## Prendergast(2015) An investigation into the effect of scour on the natural frequency of an Offshore Wind Turbine
...
::: {.callout-note icon="false"}
## Zarafshan(2012) Vibration-Based Method and Sensor for Monitoring of Bridge Scour
...
::: {.callout-note icon="false"}
## Kariyawasam(2020) Assessment of bridge natural frequency as an indicator of scour using centrifuge modelling
...
::: {.callout-note icon="false"}
## Myungjae Lee(2020) Study on Dynamic Behavior of Bridge Pier by Impact Load Test Considering Scour
...
::: {.callout-note icon="false"}
## Zarafshan(2012) Influence of soil properties on the shift in natural frequencies of a monopile-supported 5MW offshore wind turbine under scour
...
::: {.callout-note icon="false"}
## Dong-Hyawn Kim(2020) Scour Risk Assessment of Offshore Wind Turbine with Suction Bucket Foundation
...
::: {.callout-note icon="false"}
## G. Park(2022) Natural Frequency Degradation Prediction for Offshore Wind Turbine Structures
...
::: {.callout-note icon="false"}
## Ryu(2020) Closed Form Solutions for Predicting Lateral Response of Tripod Suction Pile for Offshore Wind Turbine Foundation
...
::: {.callout-note icon="false"}
## Dong-Joon Kim(2014) Investigation of Monotonic and Cyclic Behavior of Tripod Suction Bucket Foundations for Offshore Wind Towers Using Centrifuge Modeling
...
::: {.callout-note icon="false"}
## Y. Jeong (2021) Centrifuge Modeling for the Evaluation of the Cyclic Behavior of Offshore Wind Turbine with Tripod Foundation
...
::: {.callout-note icon="false"}
## Yun-Ho Seo(2020) Dynamic Characteristics of an Offshore Wind Turbine with Tripod Suction Buckets via Full-Scale Testing
...
::: {.callout-note icon="false"}
## Xuefei Wang(2017) Centrifuge modeling of lateral bearing behavior of offshore wind turbine with suction bucket foundation in sand
...
::: {.callout-note icon="false"}
## Y. Jeong(2020) Centrifuge modelling of drained pullout and compression cyclic behaviour of suction bucket
...
::: {.callout-note icon="false"}
## Nissrine Boujia(2019) Effect of Scour on the Natural Frequency Responses of Bridge Piers: Development of a Scour Depth Sensor
...
::: {.callout-note icon="false"}
## Prendergast(2013) An Investigation of the Changes in the Natural Frequency of a Pile affected by Scour
...
::: {.callout-note icon="false"}
## Kitchen(2014) Update of manual on scour at bridges and other hydraulic structures
...
 The new Manual, due in 2014, will also provide lessons learnt with case studies such as Lower Ashenbottom viaduct (2004), River Crane, Malahide viaduct and Cumbria (all 2009) and a summary of methods for the assessment of hydrodynamic forces.   [Majtan et al.](https://www.semanticscholar.org/paper/fd6d6417ded3d130b3992db7f7fc05dfcbbf94a6) critique this paper, **Kitchen et al.**, by saying:
...
::: {.callout-note icon="false"}
## Saeed(2017) Natural frequency of offshore wind turbines on rigid and flexible monopiles in cohesionless soils with linear stiffness distribution
...
::: {.callout-note icon="false"}
## Arany(2015) An analytical model to predict the natural frequency of offshore wind turbines on three-spring flexible foundations using two different beam models
...
::: {.callout-note icon="false"}
## Dong Xiaofeng(2018) Structural vibration monitoring and operational modal analysis of offshore wind turbine structure
...
::: {.callout-note icon="false"}
## Aissa(2018) Monopile head stiffness for servicibility limit state calculations in assessing the natural frequency of offshore wind turbines
...
::: {.callout-note icon="false"}
## Varghese(2022) A Compendium of Formulae for Natural Frequencies of Offshore Wind Turbine Structures
...
::: {.callout-note icon="false"}
## Bhatacharya(2011) Similitude relationships for physical modelling of monopile-supported offshore wind turbines
...
::: {.callout-note icon="false"}
## Mostafa(2019) Semi Analytical Model for the Dynamic Behavior of Offshore Wind Turbine with Flexible Foundation
...
::: {.callout-note icon="false"}
## Mouafo Robinson(2021) An Accurate Estimation of the Eigenfrequency of an Offshore Wind Turbine Considered as the Stepped Euler-Bernoulli Beam in Three-Spring Flexible Foundation Using the Power Series Method
...
::: {.callout-note icon="false"}
## Xuguang Chen(2017) Stability analysis of suction bucket foundations under wave cyclic loading and scouring
...
::: {.callout-note icon="false"}
## Sungho Park(2017) Parametric Study on Scouring around Suction Bucket Foundation
...
::: {.callout-note icon="false"}
## Young Jin Kim(2021) Ultimate Limit State Risk Assessment of Penta Pod Suction Bucket Support Structures for Offshore Wind Turbine due to Scour
...
::: {.callout-note icon="false"}
## Shu Zhu(2021) Investigation of scour effects on the vertical bearing capacity of suction caissons considering stress history
...
::: {.callout-note icon="false"}
## Rezaei(2018) Scour influence on the fatigue life of operational monopile-supported offshore wind turbines
...
::: {.callout-note icon="false"}
## Jinzhong Liu(2017) Investigation of scour effects on lateral behaviors of suction caisson
...
::: {.callout-note icon="false"}
## Xuguang Chen(2018) Model Test Study on Horizontal Static Loading of Suction Bucket Foundation under Different Scour Conditions
...
::: {.callout-note icon="false"}
## Felipe AV Jara(2006) Model testing of foundations for offshore wind turbines
...
::: {.callout-note icon="false"}
## Byrne, Houlsby(2003) Foundations for offshore wind turbines
...
::: {.callout-note icon="false"}
## Qingpeng Li(2018) Effect of scour on the behavior of a combined loaded monopile in sand
...
::: {.callout-note icon="false"}
## Cheng Lin(2014) Analysis of Laterally Loaded Piles in Sand Considering Scour Hole Dimensions
...
::: {.callout-note icon="false"}
## W Qi(2016) Scour effects on p-y curves for shallowly embedded piles in sand
...
::: {.callout-note icon="false"}
## B Zhu(2014) Deflection-Based Bearing Capacity of Suction Caisson Foundations of Offshore Wind Turbines
...
::: {.callout-note icon="false"}
## Mayall(2018) Modelling of foundation response to scour and scour protection for offshore wind turbine structures
...
::: {.callout-note icon="false"}
## Xuefei Wang(2017) Lateral capacity assessment of offshore wind suction bucket foundation in clay via centrifuge modelling
...
::: {.callout-note icon="false"}
## Zhubin(2011) Installation and lateral loading tests of suction caissons in silt
...
::: {.callout-note icon="false"}
## Kelly,Houlsby(2006) A comparison of field and laboratory tests of caisson foundations in sand and clay
...
::: {.callout-note icon="false"}
## BZhu(2013) Long-Term Lateral Cyclic Response of Suction Caisson Foundations in Sand
...
::: {.callout-note icon="false"}
## Doherty(2005) Stiffness of Flexible Caisson Foundations Embedded in Nonhomogeneous Elastic Soil
...
::: {.callout-note icon="false"}
## Y Choo(2021) Behavior of a Monopod Bucket Foundation Subjected to Combined Moment and Horizontal Loads in Silty Sand
...
::: {.callout-note icon="false"}
## Dong-Joon Kim(2013) Bearing Capacity of a Monopod Bucket Foundation for Offshore Wind Towers - Centrifuge and Numerical Modeling
...
::: {.callout-note icon="false"}
## Youn-seok Kim(2017) Model Tests for Tilting Control of Suction Bucket Foundation for Offshore Wind Turbine
...
::: {.callout-note icon="false"}
## J Tempel(2004) The effects of Scour on the design of Offshore Wind Turbines
...
::: {.callout-note icon="false"}
## J Choi(2014) Centrifuge test and numerical modeling for a suction bucket monopod foundation
...
::: {.callout-note icon="false"}
## Sung-Ryul Kim(2019) Evaluation of the Moment Bearing Capacity of Offshore Bucket Platforms in Sand
...
::: {.callout-note icon="false"}
## Plodpradit(2020) Suction Bucket Pile–Soil–Structure Interactions of Offshore Wind Turbine Jacket Foundations Using Coupled Dynamic Analysis
...
::: {.callout-note icon="false"}
## Klinkovort(2013) Scaling issues in centrifuge modelling of monopiles
...
::: {.callout-note icon="false"}
## Qingpeng Li(2020) Centrifuge Modeling of the Impact of Local and Global Scour Erosion on the Monotonic Lateral Response of a Monopile in Sand
